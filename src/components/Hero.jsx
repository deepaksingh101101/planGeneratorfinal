...
{showLanguage && <><img src={english} className="h-6 ms-5" onClick={()=>handleLanguageChange("en")}  alt="English" />
<img src={arabic} className="h-6 mx-2 " onClick={()=>handleLanguageChange("ar")}  alt="English" />
</>
}
</div>
        </div>
